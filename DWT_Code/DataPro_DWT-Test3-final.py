...
os_dir2 = "/home/njh/data/origin/TestNew/03/Sensor/"
...
#for name in range(0,1):
    ...
    app_train_merge_sensor_m['RUL']  = 187.5 - 5 * name
...
app_train_merge_sensor.to_csv('/home/njh/final_data/'+'Test_DWT03.csv',index='False')
