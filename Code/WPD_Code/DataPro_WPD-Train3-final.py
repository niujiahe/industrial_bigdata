...
os_dir1 = "/home/njh/data/origin/Train/03/Sensor/"
os_dir2 = "/home/njh/data/origin/TrainNew/01-TrainingData-additional/03/Sensor/"
#os_dir2 = "/home/njh/data/origin/TestNew/05/Sensor/"
app_train_plc = pd.read_csv("/home/njh/data/origin/Train/03/PLC/plc.csv")
...
#for name in range(0,1):
    ...
    app_train_merge_sensor_m['RUL']  = 182.5 - 5 * name
...
app_train_merge_sensor.to_csv('/home/njh/final_data/'+'Train_WPD03.csv',index='False')
